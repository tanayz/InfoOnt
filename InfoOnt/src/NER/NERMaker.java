    ...
    public static void main(String[] args) throws IOException {
      ...
      */
      if (args.length > 1) {
        ...
        String s1 = "the Bank of Italy";
        String s2 = "George Michael is in Nepal.";
        System.out.println(classifier.classifyToString(s1));
        System.out.println(classifier.classifyWithInlineXML(s1));
        String s=classifier.classifyWithInlineXML(s1);
        //s.substring(s.indexOf("<"), 4);
        System.out.println("Substring :"+s.substring(s.indexOf("<")+1, s.indexOf("<")+4));
